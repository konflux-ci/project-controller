...
require (
	...
	github.com/konflux-ci/integration-service v0.0.0-20260226102759-5a5e1b2ab06b
...
replace knative.dev/pkg => knative.dev/pkg v0.0.0-20260329160701-396dbaacd652
