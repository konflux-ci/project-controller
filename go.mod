...
require (
	...
	github.com/konflux-ci/integration-service v0.0.0-20260505221439-ec001afe3986
	github.com/konflux-ci/release-service v0.0.0-20260506091439-6a2bc9061d35
...
replace knative.dev/pkg => knative.dev/pkg v0.0.0-20260505204821-021ad709ec68
